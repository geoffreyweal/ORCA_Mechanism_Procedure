...
This section will look at how to append multiple chemical systems in various xyz files together so that you can examine the reaction pathway in either [Step 2Ba - SCAN](Step_2Ba_The_SCAN_Method.md) or [Step 2Bb - Nudged Elastic Band](Step_2Bb_The_NEB_Method.md). 

!!! note

    If your system only contains one structure where all atoms are bound to the same structure in some way, you do not need to do this step. Feel free to move on to [Step 2Ba - SCAN](Step_2Ba_The_SCAN_Method.md) or [Step 2Bb - NEB](Step_2Bb_The_NEB_Method.md).
...
!!! example
	...
	2. The second line indicates what information about the atoms is given in this file (i.e., the element and $(x,y,z)$ position). This should be ``Properties=species:S:1:pos:R:3 pbc="F F F"`` (``pbc`` here indicates there is no periodic boundary condition set).
