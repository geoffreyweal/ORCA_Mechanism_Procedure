...
<figure markdown="span">
    ...
    <img src="Figures/Investigating_Mechanisms/overall_reaction.png?raw=true#only-dark"  alt="Example Overall Reaction" width="800"/>
...
<figure markdown="span">
    ...
    <img src="Figures/Investigating_Mechanisms/Example_Reaction_Mechanism.png?raw=true#only-dark"  alt="Example Reaction Mechanism Scheme" width="1000"/>
    <figcaption>An example of reaction mechanism scheme for this overall reaction. This scheme give multiple pathways that this reaction could proceed. Only the beginning segment of the reaction mechanims have been shown here.</figcaption>
</figure>
...
<figure markdown="span">
    ...
    <img src="Figures/Investigating_Mechanisms/Example_Reaction_Mechanism_Named.png?raw=true#only-dark"  alt="Labelled Example Reaction Mechanism Scheme" width="1000"/>
