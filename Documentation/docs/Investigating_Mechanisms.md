...
There are several ways that this mechanism could proceed. Here, it is important that we **give explicit details about how we believe this reaction proceeds**. Below is an example of some of the ways this reaction could proceed, shown as a mechanistic scheme:
...
<figure markdown="span">
    ...
    <figcaption>An example of a reaction mechanism scheme for this overall reaction. This scheme gives multiple pathways that this reaction could proceed by. Only the beginning segment of the reaction mechanisms has been shown here.</figcaption>
</figure>
...
<figure markdown="span">
    ...
    <figcaption>An example of a reaction mechanism scheme for this overall reaction, where each mechanistic step has been labelled.</figcaption>
</figure>
...
<figure markdown="span">
    <img src="Figures/Investigating_Mechanisms/Folder_Holding_Reaction_Mechanism_Investigation.png?raw=true" alt="Example Folder Structure for a Reaction Mechanism Investigation" width="800"/>
    <figcaption>An example of the recommended folder structure for investigating this overall reaction, where each mechanistic step has been given its own folder.</figcaption>
</figure>
