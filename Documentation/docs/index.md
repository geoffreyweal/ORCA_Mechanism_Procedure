...
This page describes the procedure for investigating mechanistic steps of chemical mechanisms using ORCA.
...
!!! note
    ...
    The x and y axis given as R~1~ and R~2~ in the image above just indicate there is a change in spatial coordinates of the atoms in your molecule going from the reactant to the product. 
...
!!! tip "IMPORTANT"
	...
	**You should [download these templates from here](Files/Templates.zip) and customise them for your needs.**
...
!!! tip "IMPORTANT"
	...
	**You can [download these examples from here](Files/Examples.zip) to look through as you work through this procedure.**


## Questions, Feedback, and Things to Add

I am very keen for feedback about how you find the information in this Github page, both the process and the clarity of what I have written. If you have any questions about this process, feel free to write me a message.

To do this, open the [``Issues`` Github webpage](https://github.com/geoffreyweal/ORCA_Mechanism_Procedure/issues), click the ``New issue`` button, and write your question/give your feedback. 
